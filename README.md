...
- **Assistente Virtual Clara**:
  ...
  - Interface amigável com indicador de digitação.
- **Acessibilidade**:
  - Alto contraste, fontes grandes e navegação simplificada.
...
- **Frontend**: HTML5 Semântico, CSS3 (CSS Variables, Flexbox/Grid).
- **Lógica**: JavaScript (ES6+) - Vanilla JS para máxima leveza.
- **IA**: Lógica de NLP baseada em regras (Client-Side) para resposta instantânea e privacidade.
- **Ícones**: FontAwesome.
- **Fontes**: Google Fonts (Outfit e Roboto).
...
1. **Clone o repositório**:
   ```bash
   git clone https://github.com/Henriquelacerdas/Devs-Impacto.git
   ```
2. **Acesse a pasta**:
   ```bash
   cd Devs-Impacto
...
*Não é necessário instalar dependências ou rodar servidores backend. O projeto é 100% estático e pronto para deploy.*
